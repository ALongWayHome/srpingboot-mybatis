...
@Data
@ApiModel(value = "drg平均住院天数")
@ExcelIgnoreUnannotated
public class DrgSetlAvgDaysNewDTO {
    ...
    @ExcelProperty(value = "drg病组编码")
    @ApiModelProperty(value = "drg病组编码")
    private String drgCodg;

    @ExcelProperty(value = "drg病组名称")
    @ApiModelProperty(value = "drg病组名称")
